...
Revision ID: 17c9e5a80f06
Revises: b88e72faafbb
Create Date: 2026-03-01 16:55:06.145918
...
revision: str = '17c9e5a80f06'
down_revision: Union[str, Sequence[str], None] = 'b88e72faafbb'
...
def upgrade() -> None:
    ...
    op.add_column('action', sa.Column('icon', sqlmodel.sql.sqltypes.AutoString(), nullable=True))
