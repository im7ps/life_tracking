"""add sub_tasks to action

Revision ID: becc1a2ef125
Revises: 8ff36a3e0197
Create Date: 2026-03-01 00:35:07.727281
...
revision: str = 'becc1a2ef125'
down_revision: Union[str, Sequence[str], None] = '8ff36a3e0197'
...
def upgrade() -> None:
    ...
    op.add_column('action', sa.Column('sub_tasks', postgresql.JSONB(astext_type=sa.Text()), nullable=True))
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('action', 'sub_tasks')
