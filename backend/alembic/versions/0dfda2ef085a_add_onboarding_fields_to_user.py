...
Revision ID: 0dfda2ef085a
Revises: 17c9e5a80f06
Create Date: 2026-04-29 14:05:21.929740
...
revision: str = '0dfda2ef085a'
down_revision: Union[str, Sequence[str], None] = '17c9e5a80f06'
...
def upgrade() -> None:
    ...
    op.add_column('user', sa.Column('bio', sa.JSON(), server_default='{}', nullable=True))
